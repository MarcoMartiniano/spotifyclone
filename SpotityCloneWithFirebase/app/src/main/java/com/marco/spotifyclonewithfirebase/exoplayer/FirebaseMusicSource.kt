...
import com.marco.spotifyclonewithfirebase.data.entities.remote.MusicDatabase
...
//Inject porque vai precisar acessar o serviço do Database
class FirebaseMusicSource @Inject constructor(
    ...
    //IO bom para database or network operations
    ...
    //ConcatenatingMediaSource para juntar as songs (Media Source) em uma lista para tocar sem parar
